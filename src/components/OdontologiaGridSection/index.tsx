...
{professionals.length > 0 && (
  ...
  >
    <div className={styles.professionalsHeader}>
      <div className={styles.professionalsTitleContainer}>
        <FaBriefcaseMedical className={styles.titleIcon} />
        <h2 className={styles.professionalsTitle}>Nossa Equipe</h2>
      </div>
        ...
        >
          <div className={styles.professionalImageWrapper}>
            <img 
              ...
              loading="lazy"
            />
            <div className={styles.professionalOverlay}>
              <FaCheckCircle className={styles.statusIcon} />
              <span className={styles.statusText}>Atendendo</span>
            </div>
          </div>
